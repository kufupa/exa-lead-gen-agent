#!/usr/bin/env python3
"""Rebuild fullJSONs/intimate_email_contacts.json from jsons/*.enriched.json (named non-generic email)."""
...
def main() -> int:
    ...
    store.rebuild_email_document_only()
    doc_path = args.fulljsons_dir / "intimate_email_contacts.json"
