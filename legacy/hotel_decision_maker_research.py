...
Usage:
  export XAI_API_KEY=...
  python legacy/hotel_decision_maker_research.py --url https://example-hotel.com
...
Dry-run (no API key, no network):
  python legacy/hotel_decision_maker_research.py --url https://example-hotel.com --dry-run-prompt
"""
